        ...
        <div class="container mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8">
            ...
            <div class="col-span-1 sm:col-span-3 lg:col-span-3">
                <form class="space-y-2 px-5">
                    <input type="text" placeholder="Name" class="w-full px-3 py-2 bg-gray-100 text-black rounded" />
                    <input type="email" placeholder="Email" class="w-full px-3 py-2 bg-gray-100 text-black rounded" />
